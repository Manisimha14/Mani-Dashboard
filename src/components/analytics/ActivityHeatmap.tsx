  ...
  return (
    <motion.div variants={itemAnim} className="glass-card p-6">
      ...
      <div className="flex gap-2 items-start">
        {/* Day-of-week labels */}
        <div className="flex flex-col gap-1 text-[9px] text-white/30 font-mono font-bold select-none pr-1.5 pt-[2px]">
        ...
        {/* Heatmap grid */}
        <div className="flex gap-1 overflow-x-auto pb-2 flex-1 scrollbar-thin">
              ...
              {week.map(day => {
                ...
                return (
                  <div
                    ...
                    className="w-4 h-4 rounded-sm cursor-pointer transition-transform hover:scale-125 flex-shrink-0"
                    style={{ background: bg }}
      ...
      <div className="flex items-center gap-2 mt-3 pl-8">
        ...
        {[0.04, 0.25, 0.45, 0.65, 0.85].map((o, i) => (
          <div key={i} className="w-3 h-3 rounded-sm flex-shrink-0" style={{ background: `rgba(139,92,246,${o})` }} />
        ))}
