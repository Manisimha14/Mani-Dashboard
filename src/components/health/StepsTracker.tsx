...
export default function StepsTracker({ today }: { today: string }) {
  ...
  const [syncError, setSyncError] = useState<GoogleFitSyncFeedback | null>(null);
  ...
  // Unified sync workout name for reliable deduplication
    ...
    <div className="space-y-6">
          ...
          <div className="flex-1 pr-6">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-blue-500/20 hover:bg-blue-500/35 border border-blue-500/30 text-white font-bold transition-all text-[11px] flex items-center gap-1.5 cursor-pointer"
              >
                Retry Sync
              </button>
      ...
      <div className="glass-card p-5 relative overflow-hidden bg-gradient-to-r from-blue-500/5 to-emerald-500/5 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-white/40 mt-0.5">
              Pull validated step and movement totals through the secure server-side Google Fit sync path.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5">
          ...
          >
            <Zap size={12} /> Reconnect Google Fit
          </motion.button>
        </div>
      </div>
      {/* Hero Ring */}
