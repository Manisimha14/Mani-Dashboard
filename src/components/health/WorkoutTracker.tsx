      ...
      <div className="glass-card p-5 relative overflow-hidden bg-gradient-to-r from-blue-500/5 to-orange-500/5 border border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-2.5">
          <motion.button
            ...
            disabled={!user}
            className="px-4 py-2 rounded-xl text-xs font-bold bg-orange-500/10 text-orange-400 border border-orange-500/25 flex items-center gap-1.5 hover:bg-orange-500/20 transition-all shadow-[0_0_12px_rgba(249,115,22,0.1)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
