...
const MINDSET_MODES = {
  focused: {
    ...
    pulseSpeed: 3,
    description: 'High working memory allocation. Gamma brainwaves synchronized. Optimized for deep algorithmic coding and complex problem-solving.',
  },
  creative: {
    id: 'creative',
    label: 'Creative Flow',
    ...
    pulseSpeed: 5,
    description: 'Alpha waves dominant. Enhanced lateral thinking active. Ideal for prototyping visual interfaces, copywriting, and design architecting.',
  },
  grind: {
    id: 'grind',
    label: 'High Hustle',
    ...
    pulseSpeed: 1.5,
    description: 'Beta activity peak. Peak task velocity, maximum adrenaline processing efficiency. Optimized for high-throughput coding sprints.',
  },
  chill: {
    id: 'chill',
    label: 'Zen Recovery',
    ...
    pulseSpeed: 8,
    description: 'Theta and delta waves dominant. Parasympathetic nervous system active. Replenishing neural neurotransmitters and cognitive capacity.',
  },
};
    ...
    <div className="w-full glass-card p-6 border border-white/10 rounded-3xl bg-black/40 backdrop-blur-xl relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.6)]">
      ...
      <div className="relative space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-white/5 pb-4">
          <div>
            <h3 className="text-xs font-black text-white/40 uppercase tracking-[0.25em]">Cognitive Cockpit</h3>
            <p className="text-[10px] text-white/20 uppercase tracking-widest mt-1">Reactive Mindset Tuning Panel</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center">
          ...
          <div className="space-y-2.5">
            <div className="text-[9px] font-black uppercase text-white/30 tracking-widest mb-1.5">Tuning Selectors</div>
          ...
          {/* Column 2: Bio-Performance Telemetry */}
          <div className="space-y-4.5">
            <div className="text-[9px] font-black uppercase text-white/30 tracking-widest mb-1">Performance Telemetry</div>
          ...
          {/* Column 3: Immersive Mindset Aura */}
          <div className="p-4 bg-white/[0.02] border border-white/5 rounded-2xl relative overflow-hidden flex flex-col justify-between min-h-[172px]">
            ...
            <div className="space-y-2 relative z-10">
              <div className="text-[9px] font-black uppercase text-white/30 tracking-widest">Active Mindset Aura</div>
              <motion.div
                key={activeMode.id}
                initial={{ opacity: 0, y: 5 }}
                animate={{ opacity: 1, y: 0 }}
                className="text-xs font-bold text-white leading-relaxed line-clamp-4"
              >
            ...
            <div className="mt-4 flex items-center justify-between border-t border-white/5 pt-3 relative z-10">
              <span className="text-[8px] font-black uppercase tracking-widest text-white/20">Aura Synced</span>
